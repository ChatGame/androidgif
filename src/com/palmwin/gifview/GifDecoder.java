...
public class GifDecoder implements Runnable {
    ...
    private boolean decodingFlag = false;
    ...
    public GifDecoder(InputStream is, String gifName, boolean sync) {
        this.gifName = gifName;
        this.in = is;
    ...
    public GifFrame getFrame(int n) {
        ...
        while (frame != null) {
            if (i == n) {
                if (frame.image == null) {
                    frame.image = Bitmap.createBitmap(frame.colors, width,
    ...
    private int readStream() {
        ...
        for (int i = 0; i < this.getFrameCount(); i++) {
            delay.append(this.getFrame(i).delay);
            delay.append(" ");
        }
        System.out.println("gif " + delay.toString());
        return this.status;
    }
